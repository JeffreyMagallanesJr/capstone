    ...
    <div class="sidebar-menu-inner">
        ...
        <header class="logo-env">
            ...
            <div class="logo">
                ...
                <h3 class="" style="color: #fff !important; margin-bottom: 0px !important; font-size: 18px;">Management</h3>
                <h3 class="" style="color: #fff !important; margin-bottom: 0px !important; font-size: 18px;">System</h3>
            </div>

            <!-- logo collapse icon -->
            <div class="sidebar-collapse">
                <a href="#" class="sidebar-collapse-icon">
                    <i class="entypo-menu" style="font-size: 22px;"></i>
                </a>
            </div>
