...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
            ...
            Category Name:
            <select>
                <option>Select a Category by clicking here</option>
            ...
            Sub-Category Name:
            <select>
                <option>Select a Sub-Category by clicking here</option>
            </select> <br> <br>
            ...
            Reminder: <input type="datetime-local" placeholder="Reminder" name="reminder"> <br> <br>
